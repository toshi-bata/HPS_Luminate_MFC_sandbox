...
namespace hoops_luminate_bridge {
    ...
    class HoopsLuminateBridge {
      ...
      public:
         ...
         */
        virtual RED::Object* getSelectedLuminateTransformNode() = 0;
         ...
         * @param[in] a_useCameraPosition If true, use camera position to create the light, otherwise use information from luminate light.
      ...
      private:
         ...
         * @return RED_OK if success, otherwise error code.
         */
        static RED_RC createCamera(RED::Object* a_window, int a_windowWidh, int a_windowHeight, RED::Object*& a_outCamera);
    };
