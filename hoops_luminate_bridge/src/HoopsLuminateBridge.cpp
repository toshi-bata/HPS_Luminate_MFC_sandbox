...
namespace hoops_luminate_bridge {
    ...
    bool HoopsLuminateBridge::initialize(std::string const& a_license,
                                         ...
                                         Visual* a_visual,
#endif
                                         std::string const& a_environmentMapFilepath)
    {
        //////////////////////////////////////////
    ...
    bool HoopsLuminateBridge::resize(int a_windowWidth, int a_windowHeight)
    {
        //////////////////////////////////////////
    ...
    bool HoopsLuminateBridge::syncScene()
    {
        //////////////////////////////////////////
        // Retrieve the resource manager from singleton
        //////////////////////////////////////////
    ...
    RED_RC HoopsLuminateBridge::checkCameraSync()
    {
        RED_RC rc = RED_OK;
    ...
    RED_RC HoopsLuminateBridge::syncLuminateCamera()
    {
        CameraInfo cameraInfo = getCameraInfo();

        Handedness viewHandedness =
            m_conversionDataPtr != nullptr ? m_conversionDataPtr->viewHandedness : Handedness::RightHanded;
        RED_RC rc = syncCameras(m_camera, viewHandedness, m_windowWidth, m_windowHeight, cameraInfo);
    ...
    RED_RC
    HoopsLuminateBridge::createCamera(RED::Object* a_window, int a_windowWidh, int a_windowHeight, RED::Object*& a_outCamera)
    {
        //////////////////////////////////////////
        ...
        RC_TEST(createRedCamera(a_window, a_windowWidh, a_windowHeight, a_outCamera));
    ...
    RED_RC HoopsLuminateBridge::setSunSkyLightEnvironment()
    {
        ...
        addSunSkyModel(m_window, m_conversionDataPtr->rootTransformShape, m_sunSkyLightingModel);
        resetFrame();

        return RED_OK;
    }

    RED_RC HoopsLuminateBridge::setEnvMapLightEnvironment(std::string const& a_imageFilepath,
                                                          bool a_showImage,
    ...
    RED_RC createRedCamera(RED::Object* a_window, int a_windowWidth, int a_windowHeight, RED::Object*& a_outCamera)
    {
        a_outCamera = nullptr;
        ...
        RED::Object* defaultVRLObj = NULL;
        RC_TEST(iwindow->GetVRL(defaultVRLObj, 0));
